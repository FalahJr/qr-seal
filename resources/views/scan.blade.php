...
<div class="desktop-render-area">
    ...
    <div class="container text-center">
        ...
        <img src="{{ URL::asset('img/notfound.svg') }}" alt="" class="w-50 pt-5">
        <h3>Silahkan Scan Qr dari perangkat lain untuk cek validasi QR Code dokumen</h3>
    </div>
        ...
        async function scanPDF() {
            ...
            for (const imageData of pdfImages) {
                ...
                console.log('Barcode scan result:',
                    result); // Tambahkan ini untuk melihat hasil pemindaian barcode di konsol
